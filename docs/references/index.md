...
Canonical for: detailed setup guides, low-level contracts, and external- or integration-facing reference material
Audience: contributors who already know the topic they need and want the detailed source
Update when: a reference document is added, replaced, or materially changed
